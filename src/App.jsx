...
// ============================================================
var THEMES=[
  {id:'neutral',name:'Default',dark:false,paper:'#F5F0E6',surface:'#EDE6D8',surfaceAlt:'#E8E0CE',border:'#E0D9C9',borderStrong:'#C9C1AE',ink:'#1A1A1A',inkSoft:'#3A3A38',muted:'#6B6B68',mutedSoft:'#8B8B85',primary:'#B73E36',secondary:'#1A1A1A',gradient:['#F5F0E6','#F0EADC','#EDE6D8'],accentTh:'#B73E36',accentRt:'#B73E36',accentPct:'#6B6B68',dots:['#B73E36','#1A1A1A','#6B6B68'],metricColor:'#B73E36',descriptorColor:'#6B6B68',subColor:'#6B6B68'},
