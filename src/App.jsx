...
export default function Dashboard(){
  ...
  // Public: Overview, Taste, Rankings. Admin-only: People and Where (they name real
  // people and specific venues), plus the Costs and Tags bookkeeping.
  var PUBLIC_TABS=['overview','taste','rankings'];
  var TABS=isAdmin?TABS_ALL:TABS_ALL.filter(function(t){return PUBLIC_TABS.indexOf(t.id)!==-1});
